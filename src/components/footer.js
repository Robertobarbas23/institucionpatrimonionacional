...
const Footer = () => (
  <footer style={{ backgroundColor: '#333', color: '#FFF', padding: '40px 20px' }}>
    ...
    <div style={{ borderTop: '1px solid #555', marginTop: '20px', paddingTop: '20px', textAlign: 'center' }}>
      ...
      <div>
        <img src="src/images/logogobierno.png" alt="Gobierno de España" style={{ width: '150px', marginBottom: '20px' }} />
      ...
      <div style={{ marginTop: '20px' }}>
        ...
        <a href="#"><img src="tiktok-icon.png" alt="Twitter" style={{ width: '30px' }} /></a>
