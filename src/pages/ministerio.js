...
<br></br>
<img src={imagenAlmeida} alt="src/images/almeida.jpg" width = "200px"/>
<h2>JOSÉ LUIS MARTÍNEZ-ALMEIDA NAVASQÜÉS</h2>
<p style={{ textAlign: "justify" }}>Alcalde de Madrid.
...
El 13 de enero de 2019 fue designado Candidato a la Alcaldía de Madrid por el Partido Popular y, tras las elecciones municipales de 26 de mayo de 2020, fue elegido Alcalde de Madrid (Sesión de Investidura de 15 de junio de 2020).</p>
<br></br>
<br></br>
<img src={imagenGerente} alt="src/images/gerente.jpg" width = "200px"/>
<h2>GERENTE DE PATRIMONIO NACIONAL</h2>
<p style={{ textAlign: "justify" }}>Es Licenciada en Ciencias Económicas y Empresariales, rama de Economía de la Empresa, por la Universidad Complutense de Madrid. Funcionaria en servicio activo de la Escala Técnica de Gestión de Organismos Autónomos y en excedencia del Cuerpo Técnico de Auditoría y Contabilidad, Executive Master in Public Administration (EMPA). ESADE.
...
<br></br>
<img src={imagenHistoriaarte} alt="src/images/historiaarte.jpg" width = "200px"/>
<h2>ANA MARÍA ARIAS DE COSSÍO</h2>
<p style={{ textAlign: "justify" }}>Doctora en Historia del Arte y catedrática emérita de la Universidad Complutense de Madrid.
...
<br></br>
<img src={imagenIngenierosuperior} alt="src/images/ingenierosuperior.jpg" width = "200px"/>
<h2>FRANCISCO BELIL CREIXELL</h2>
<p style={{ textAlign: "justify" }}>Ingeniero Superior en la Universidad Politécnica de Cataluña.
...
<br></br>
<img src={imagenLiteratura} alt="src/images/literatura.jpg" width = "200px"/>
<h2>Mª ÁNGELES HERMOSILLA ÁLVAREZ</h2>
<p style={{ textAlign: "justify" }}>Catedrática de Teoría de la Literatura y Literatura Comparada en la Universidad de Córdoba.
...
<br></br>
<img src={imagenPresidenteteatro} alt="src/images/presidenteteatro.jpg" width = "200px"/>
<h2>GREGORIO MARAÑÓN Y BERTRÁN DE LIS</h2>
<p style={{ textAlign: "justify" }}>Presidente del Teatro Real y de la Fundación Ortega-Marañón.
...
<br></br>
<img src={imagenRealacademia} alt="src/images/realacademia.jpg" width = "200px"/>
<h2>MARÍA DEL CARMEN IGLESIAS CANO</h2>
<p style={{ textAlign: "justify" }}>Directora de la Real Academia de la Historia desde diciembre de 2014 (reelegida en 2018)
...
<br></br>
<img src={imagenSecretariageneral} alt="src/images/secretariageneral.jpg" width = "200px"/>
<h2>JUDIT ALEXANDRA GONZÁLEZ PEDRAZ</h2>
<p style={{ textAlign: "justify" }}>Secretaria general de la Presidencia del Gobierno.
...
Ha colaborado como profesora asociada en la Universidad Carlos III de Madrid y participado en diversos proyectos de investigación.</p>
<br></br>
<img src={imagenSecretariogeneralrey} alt="src/images/secretariogeneralrey.jpg" width = "200px"/>
<h2>DOMINGO MARTÍNEZ PALOMO</h2>
<p style={{ textAlign: "justify" }}>Secretario general de la Casa de su Majestad el Rey.
...
Por Real Decreto 888/2015, de 2 de octubre, fue promovido al empleo de Teniente General del Cuerpo de la Guardia Civil. Por Real Decreto 85/2017, de 10 de febrero, fue nombrado Vocal del Consejo de Administración del Patrimonio Nacional.</p>
<br></br>
<img src={imagenSubsecretario} alt="src/images/subsecretario.jpg" width = "200px"/>
<h2>JAVIER SOLANA DE MADARIAGA</h2>
<p style={{ textAlign: "justify" }}>Doctor en Ciencias Físicas y catedrático por la Universidad Complutense de Madrid.
